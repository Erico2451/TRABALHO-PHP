                ...
                <div class="col-12 col-md-6 col-lg-9">
                    ...
                    <div class="row mt-5">
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="card">
                                <img src="../img/halo350x400.png" class="card-img-top" alt="Texto Alternativo">
                                <div class="card-body">
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="card">
                                <img src="../img/fortinaite350x400.png" class="card-img-top" alt="Texto Alternativo">
                                <div class="card-body">
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="card">
                                <img src="../img/zelda350x400.png" class="card-img-top" alt="Texto Alternativo">
                                <div class="card-body">
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="card">
                                <img src="../img/fifa350x400.png" class="card-img-top" alt="Texto Alternativo">
                                <div class="card-body">
